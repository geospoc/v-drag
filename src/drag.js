const createOverlay = (e, el, _data) => {
...
const adjustElementZIndex = (el, index) => {
  el.style.zIndex = index;
};

const mousedown = (e, el, _data) => {
  ...
  if (
    ...
    !checkIfIdInPath(_data.draggableElementId, e.path)
  ) {
    return;
  }
...
const setDraggerOffset = (el, _data) => {
